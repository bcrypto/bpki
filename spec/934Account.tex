...
\sstr{termsOfServiceAgreed}, \sstr{externalAccountBinding} и одним 
...
Поля \sstr{contact}, \sstr{termsOfServiceAgreed} и 
...
сказано о возможности формирования поля клиентом.
%
...
\item
Проверить, что защищаемые поля объекта JWS соответствуют вышеуказанным 
правилам.  
\item 
