...
идентификаторами в расширении \token[ENTITIES.SAN]{SubjectAltName}) или связать 
...
%
Cервер возвращает ответ c кодом статуса 200 и обновленным вызовом авторизации.
