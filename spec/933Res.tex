...
ссылки может уточняться веб-отношениями~\cite{RFC8288}. 
%
...
\hline
%
Ответить на вызовов авторизации & 
...
%
Скачать сертификат & 
\code|POST-as-GET| адреса сертификатов заявки & 
200\\
\hline
\end{tabular}
\end{table}
...
объект JWS, который привязывает внешней учетную запись клиента к учетной записи 
