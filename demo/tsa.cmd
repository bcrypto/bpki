...
rem \remark По умолчанию вместо SigningCertificateV2 используется rem атрибут 
rem SigningCertificate, и этот атрибут строится с помощью хэш-функции sha1.
rem Для включения SigningCertificateV2 в поле ess_cert_id_alg секции tsa
rem конфигурационного файла следует указать имя альтернативной хэш-функции.
rem ===========================================================================
