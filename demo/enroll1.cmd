...
echo    3 signing CSR(%1) by opRA 

openssl cms -sign -signer out/opra/cert_opra -inkey out/opra/privkey_opra ^
  -in out/%1/req_%1 -inform pem -passin pass:opraopraopra ^
...
openssl cms -verify -in out/%1/recovered_signed_req_%1.der -inform der ^
  ...
  -signer out/%1/verified_cert_opra -out out/%1/verified_req_%1 ^
  -purpose any 2> NUL
...
echo    11 processing CSR(%1).challengePassword 
...
openssl cms -decrypt -in out/%1/enveloped_cert_%1.der -inform der ^
 -inkey out/opra/privkey_opra -out out/%1/cert_%1 -outform pem ^
